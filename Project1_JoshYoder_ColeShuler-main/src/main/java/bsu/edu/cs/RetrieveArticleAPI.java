...
public class RetrieveArticleAPI {
    ...
    public String getData() throws IOException {
        ...
        retrieveArticleDataFromAPI(article);
        return retrieveArticleDataFromAPI(article);
    }//end getData
    ...
    public String getArticleName() {
        ...
        String article = input.nextLine().toLowerCase();
        exception.checkForArticleName(article);
        return article;
    }//end getArticleName
